                                ...
                                const float trans_std)
{
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(
      data.scalar_type(), "deformable_psroi_pool_forward", ([&] {
        ...
        DeformablePSROIPoolForwardKernel<scalar_t><<<GET_BLOCKS(count), CUDA_NUM_THREADS>>>(
                                    ...
                                    const float trans_std)
{
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(
      out_grad.scalar_type(), "deformable_psroi_pool_backward_acc", ([&] {
        ...
        DeformablePSROIPoolBackwardAccKernel<scalar_t><<<GET_BLOCKS(count), CUDA_NUM_THREADS>>>(
